...
20260703: 
The efficiency of the Heaps algorithm was underestimated due to oversight in the checksum check. Therefore, the pp performance has been corrected to speedup 1.X.
**By using a pre-compiled N, the Position Pure algorithm can achieve a speedup of approximately 6 times compared to the Heaps algorithm. I will modify it very soon.**
...
|---|---|---|---|
| 9 | 0.000797 | 0.000860 | .92x |
| 10 | 0.014159 | 0.008328 | 1.70x |
| 11 | 0.100114 | 0.064196 | 1.55x |
| 12 | 1.150519 | 0.718127 | 1.60x |
| 13 | 15.029570 | 8.546830 | 1.75x |
...
```
 Hu, Yusheng, Position Method: A Linear-Time Generation Algorithm for Permutations (February 22, 2026). Available at SSRN: https://ssrn.com/abstract=6285581 or http://dx.doi.org/10.2139/ssrn.6285581 

 Hu, Yusheng, Dual Position Pure Algorithm: A Cyclic Ring Topology for Rapid Permutation Generation (May 27, 2026). Available at SSRN: https://ssrn.com/abstract=6835520 or http://dx.doi.org/10.2139/ssrn.6835520 
```
